...
# >>> Training <<<
python main.py --learning-rate 4e-5 --weight-decay 0 --batch-size 32 --epochs 21 --log-interval 400 \
    --grad-accum-steps 1 --model-type roberta --prefix 0524 --filename final --task ast
# >>> Examine Results <<<
