...
print("first argmax lexical")
print(accscore(true_labels, first_argmax_lexical_preds))
...
print("first argmax sbert")
print(accscore(true_labels, first_argmax_sbert_preds))
