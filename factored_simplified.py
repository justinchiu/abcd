...
def prepare_dataloader(tok, answer_tok, args):
    ...
    paras, docs, doc_idxs, supps, answs, labels = prepare_subflow_abcd(tok, answer_tok, "train", num_distractors=args.num_distractors)
    tparas, tdocs, tdoc_idxs, tsupps, tansws, tlabels = prepare_subflow_abcd(tok, answer_tok, "val", num_distractors=args.num_distractors)
...
def main():
    ...
    answer_tokenizer = AutoTokenizer.from_pretrained(args.answer_model_dir, truncation_side="left")
    #data = load_hotpotqa()
